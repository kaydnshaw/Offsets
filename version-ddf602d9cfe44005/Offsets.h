...
namespace Offsets {
    ...
    namespace Attribute {
         ...
         inline constexpr uintptr_t TypeIdRvaNew = 0x868cb94;
    ...
    namespace Clothing {
         inline constexpr uintptr_t Color3 = 0x10c;
    ...
    namespace Humanoid {
         ...
         inline constexpr uintptr_t DisplayName = 0xe0;
    ...
    namespace Instance {
         ...
         inline constexpr uintptr_t ClassByName = 0x2b7aff4;
    ...
    namespace Luau {
         ...
         inline constexpr uintptr_t luaC_step = 0xb46cb0;
         inline constexpr uintptr_t luaC_step_work = 0xb469e0;
    ...
    namespace LuauGlobal {
         ...
         inline constexpr uintptr_t dummynode = 0x610eeb8;
    ...
    namespace ProximityPrompt {
         inline constexpr uintptr_t Enabled = 0x3d;
         inline constexpr uintptr_t RequiresLineOfSight = 0x105;
    }
    ...
    namespace TextButton {
         ...
         inline constexpr uintptr_t TextXAlignment = 0xd60;
    ...
    namespace TextLabel {
         ...
         inline constexpr uintptr_t TextXAlignment = 0xae0;
         inline constexpr uintptr_t TextYAlignment = 0xd;
    }
