...
namespace Offsets {
    ...
    namespace Alloc {
         inline constexpr uintptr_t Malloc = 0x7ae130;
    }
    ...
    namespace BasePart {
         ...
         inline constexpr uintptr_t Shape = 0x154;
    ...
    namespace Instance {
         ...
         inline constexpr uintptr_t ClassByName = 0x46aaa70;
         ...
         inline constexpr uintptr_t FromExisting = 0x40ac110;
         inline constexpr uintptr_t Name = 0x8;
         inline constexpr uintptr_t NameContainer = 0x70;
         inline constexpr uintptr_t New = 0x40ab4d0;
         inline constexpr uintptr_t Parent = 0x68;
         inline constexpr uintptr_t SetParent = 0x7ae7a0;
    ...
    namespace ModuleScript {
         ...
         inline constexpr uintptr_t IsRobloxScript = 0x13c0;
    }
    ...
    namespace Reflection {
         ...
         inline constexpr uintptr_t CreatorTable = 0x88361c8;
         inline constexpr uintptr_t EntryValue = 0x8;
         inline constexpr uintptr_t NameRegistry = 0x8730388;
    ...
    namespace Sky {
         inline constexpr uintptr_t DrawAdv = 0x366aa26;
         inline constexpr uintptr_t DrawCube = 0x3666060;
         inline constexpr uintptr_t DrawCubeCallA = 0x366239e;
         inline constexpr uintptr_t DrawCubeCallB = 0x36620ad;
